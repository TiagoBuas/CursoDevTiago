...
test("response should be the current used connections of the postgreSQL local DB", async () => {
  ...
  expect(responseBody.dependencies.database.current_used_connections).not.toBeNull();
  expect(responseBody.dependencies.database.current_used_connections).toBeGreaterThan(0);
